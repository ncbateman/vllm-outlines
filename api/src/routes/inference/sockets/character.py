...
from src.model.schema.character import Character
...
logits_processor = JSONLogitsProcessor(schema=Character, llm=dummy_llm)

@router.websocket("/ws/inference/character")
    ...
    try:
        while True:
            ...
            if 'prompt' in data:
                ...
                await websocket.send_json({"error": "Missing 'prompt' in request."})
